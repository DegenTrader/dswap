...
const useUtilityClasses = ownerState => {
  const slots = {
    root: ['root', ownerState.inset && `inset${(0, _utils.unstable_capitalize)(ownerState.inset)}`]
  };
  return (0, _composeClasses.default)(slots, _listDividerClasses.getListDividerUtilityClass, {});
};

const ListDividerRoot = (0, _styles.styled)('li', {
  name: 'JoyListDivider',
  slot: 'Root',
...
const ListDivider = /*#__PURE__*/React.forwardRef(function ListDivider(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(ListDividerRoot, (0, _extends2.default)({
    ref: ref,
    as: component,
