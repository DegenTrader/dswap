...
exports.isVariantPalette = exports.createVariantStyle = exports.createVariant = exports.createTextOverrides = exports.createContainedOverrides = void 0;
...
const createTextOverrides = theme => {
  const {
    prefix,
    getCssVar
  } = theme;
...
exports.createTextOverrides = createTextOverrides;

const createContainedOverrides = theme => {
  const {
    prefix,
    getCssVar
  } = theme;
...
exports.createContainedOverrides = createContainedOverrides;
