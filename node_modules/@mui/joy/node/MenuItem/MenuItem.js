...
const useUtilityClasses = ownerState => {
  const {
    ...
    disabled,
    selected
  } = ownerState; // Does not need to create state clases: focusVisible, disabled, and selected because ListItemButton already takes care of them.
...
= {
  ...
  .oneOfType([_propTypes.default.oneOf(['context', 'danger', 'info', 'neutral', 'primary', 'success', 'warning']), _propTypes.default.string]),
