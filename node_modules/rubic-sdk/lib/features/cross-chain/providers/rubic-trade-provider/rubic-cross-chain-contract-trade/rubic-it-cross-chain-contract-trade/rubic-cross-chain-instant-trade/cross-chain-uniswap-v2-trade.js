...
exports.CrossChainUniswapV2Trade = void 0;
var core_1 = require("../../../../../../../core");
var provider_type_enum_1 = require("../../../../common/celer-rubic/models/provider-type.enum");
var common_1 = require("../../../../../../../common");
var CrossChainUniswapV2Trade = /** @class */ (function () {
    function CrossChainUniswapV2Trade(instantTrade) {
        this.instantTrade = instantTrade;
        this.defaultDeadline = 999999999999999;
    }
    CrossChainUniswapV2Trade.prototype.getFirstPath = function () {
        return this.instantTrade.wrappedPath.map(function (token) { return token.address; });
    };
    CrossChainUniswapV2Trade.prototype.getSecondPath = function () {
        return this.instantTrade.wrappedPath.map(function (token) { return core_1.Web3Pure.addressToBytes32(token.address); });
    };
    CrossChainUniswapV2Trade.prototype.modifyArgumentsForProvider = function (methodArguments, _walletAddress, swapTokenWithFee) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!(methodArguments === null || methodArguments === void 0 ? void 0 : methodArguments[0])) {
                    throw new common_1.RubicSdkError('Method arguments must not be empty');
                }
    ...
    CrossChainUniswapV2Trade.prototype.getCelerSourceObject = function () {
        var path = this.getFirstPath();
        var amountOutMinimum = this.instantTrade.toTokenAmountMin.stringWeiAmount;
        var dex = this.instantTrade.contractAddress;
        return { dex: dex, path: path, deadline: this.defaultDeadline, amountOutMinimum: amountOutMinimum };
    };
    CrossChainUniswapV2Trade.prototype.getCelerDestinationObject = function (integratorAddress, receiverAddress) {
        var dex = this.instantTrade.contractAddress;
    ...
    return CrossChainUniswapV2Trade;
}());
exports.CrossChainUniswapV2Trade = CrossChainUniswapV2Trade;
//# sourceMappingURL=cross-chain-uniswap-v2-trade.js.map