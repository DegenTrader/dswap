...
var sushi_swap_polygon_trade_1 = require("./sushi-swap-polygon-trade");
var SushiSwapPolygonProvider = /** @class */ (function (_super) {
    __extends(SushiSwapPolygonProvider, _super);
    function SushiSwapPolygonProvider() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.blockchain = blockchain_name_1.BLOCKCHAIN_NAME.POLYGON;
        _this.InstantTradeClass = sushi_swap_polygon_trade_1.SushiSwapPolygonTrade;
        _this.providerSettings = constants_1.SUSHI_SWAP_POLYGON_PROVIDER_CONFIGURATION;
        return _this;
    }
    return SushiSwapPolygonProvider;
