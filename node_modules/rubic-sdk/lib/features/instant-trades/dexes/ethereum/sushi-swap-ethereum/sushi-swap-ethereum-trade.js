...
var SushiSwapEthereumTrade = /** @class */ (function (_super) {
    __extends(SushiSwapEthereumTrade, _super);
    function SushiSwapEthereumTrade(tradeStruct) {
        var _this = _super.call(this, tradeStruct) || this;
        _this.contractAddress = constants_1.SUSHI_SWAP_ETHEREUM_CONTRACT_ADDRESS;
        return _this;
    }
    Object.defineProperty(SushiSwapEthereumTrade, "type", {
        get: function () {
            return features_1.TRADE_TYPE.SUSHI_SWAP;
        },
        enumerable: false,
        configurable: true
    });
    return SushiSwapEthereumTrade;
