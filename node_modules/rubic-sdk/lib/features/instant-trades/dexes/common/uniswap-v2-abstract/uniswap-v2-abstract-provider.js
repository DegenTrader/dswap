...
var UniswapV2AbstractProvider = /** @class */ (function (_super) {
     ...
     * @param options Additional options.
     */
    UniswapV2AbstractProvider.prototype.calculateExactOutputAmount = function (from, to, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.calculateExactOutput(from, to, options)];
