 ...
 */
export declare function wrappedAmount(tokenAmount: TokenAmount): TokenAmount;
export declare function wrappedToken(token: Token): Token;
/**
...
export declare class Trade {
     ...
     */
    static bestTradeExactIn(pairs: Pair[], tokenAmountIn: TokenAmount, tokenOut: Token, { maxNumResults, maxHops }?: BestTradeOptions, currentPairs?: Pair[], originalAmountIn?: TokenAmount, bestTrades?: Trade[]): Trade[];
    /**
     ...
     * @param bestTrades used in recursion; the current list of best trades
     */
    static bestTradeExactOut(pairs: Pair[], tokenIn: Token, tokenAmountOut: TokenAmount, { maxNumResults, maxHops }?: BestTradeOptions, currentPairs?: Pair[], originalAmountOut?: TokenAmount, bestTrades?: Trade[]): Trade[];
}
export {};
