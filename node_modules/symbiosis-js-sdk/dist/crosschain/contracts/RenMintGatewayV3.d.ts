...
export interface RenMintGatewayV3Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: '_burnFromPreviousGateway', values: [string, string, BytesLike, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: '_mintFromPreviousGateway', values: [BytesLike, BigNumberish, BytesLike, BytesLike, string]): string;
...
export declare type LogAssetUpdatedEvent = TypedEvent<[string, string], {
    asset: string;
    selectorHash: string;
}>;
...
export declare type LogBurnToChainEvent = TypedEvent<[
    string,
    string,
    string,
    BigNumber,
...
export declare type LogBurnToChainEventFilter = TypedEventFilter<LogBurnToChainEvent>;
...
export declare type TokenOwnershipTransferredEvent = TypedEvent<[
    string,
    string
], {
    tokenAddress: string;
...
export declare type TokenOwnershipTransferredEventFilter = TypedEventFilter<TokenOwnershipTransferredEvent>;
export interface RenMintGatewayV3 extends BaseContract {
    ...
    functions: {
        ...
        __MintGateway_init(asset_: string, signatureVerifier_: string, token_: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        _burnFromPreviousGateway(recipientAddress: string, recipientChain: string, recipientPayload: BytesLike, amount: BigNumberish, caller: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        _mintFromPreviousGateway(pHash: BytesLike, amount: BigNumberish, nHash: BytesLike, sig: BytesLike, caller: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        'burn(bytes,uint256)'(recipient: BytesLike, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        'burn(string,uint256)'(recipient: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        burnWithPayload(recipientAddress: string, recipientChain: string, recipientPayload: BytesLike, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        mint(pHash: BytesLike, amount: BigNumberish, nHash: BytesLike, sig: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        owner(overrides?: CallOverrides): Promise<[string]>;
        status(hash: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        token(overrides?: CallOverrides): Promise<[string]>;
        transferTokenOwnership(nextTokenOwner: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        __MintGateway_init(asset_: string, signatureVerifier_: string, token_: string, overrides?: CallOverrides): Promise<void>;
        _burnFromPreviousGateway(recipientAddress: string, recipientChain: string, recipientPayload: BytesLike, amount: BigNumberish, caller: string, overrides?: CallOverrides): Promise<BigNumber>;
        _mintFromPreviousGateway(pHash: BytesLike, amount: BigNumberish, nHash: BytesLike, sig: BytesLike, caller: string, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        burnWithPayload(recipientAddress: string, recipientChain: string, recipientPayload: BytesLike, amount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getAsset(overrides?: CallOverrides): Promise<string>;
        getEventNonce(overrides?: CallOverrides): Promise<BigNumber>;
        getPreviousGateway(overrides?: CallOverrides): Promise<string>;
        getSelectorHash(overrides?: CallOverrides): Promise<string>;
        getSignatureVerifier(overrides?: CallOverrides): Promise<string>;
        getToken(overrides?: CallOverrides): Promise<string>;
        mint(pHash: BytesLike, amount: BigNumberish, nHash: BytesLike, sig: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        owner(overrides?: CallOverrides): Promise<string>;
        status(hash: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        token(overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        ...
        'LogBurn(bytes,uint256,uint256,bytes)'(to?: null, amount?: null, burnNonce?: BigNumberish | null, indexedTo?: BytesLike | null): LogBurnEventFilter;
        LogBurn(to?: null, amount?: null, burnNonce?: BigNumberish | null, indexedTo?: BytesLike | null): LogBurnEventFilter;
        'LogBurnToChain(string,string,bytes,uint256,uint256,string,string)'(recipientAddress?: null, recipientChain?: null, recipientPayload?: null, amount?: null, burnNonce?: BigNumberish | null, recipientAddressIndexed?: string | null, recipientChainIndexed?: string | null): LogBurnToChainEventFilter;
        LogBurnToChain(recipientAddress?: null, recipientChain?: null, recipientPayload?: null, amount?: null, burnNonce?: BigNumberish | null, recipientAddressIndexed?: string | null, recipientChainIndexed?: string | null): LogBurnToChainEventFilter;
        'LogMint(address,uint256,uint256,bytes32)'(to?: string | null, amount?: null, sigHash?: BigNumberish | null, nHash?: BytesLike | null): LogMintEventFilter;
        LogMint(to?: string | null, amount?: null, sigHash?: BigNumberish | null, nHash?: BytesLike | null): LogMintEventFilter;
        ...
        'TokenOwnershipTransferred(address,address)'(tokenAddress?: string | null, nextTokenOwner?: string | null): TokenOwnershipTransferredEventFilter;
        TokenOwnershipTransferred(tokenAddress?: string | null, nextTokenOwner?: string | null): TokenOwnershipTransferredEventFilter;
    };
    estimateGas: {
