...
export interface AdaRouterInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'addLiquidityADA', values: [string, BigNumberish, BigNumberish, BigNumberish, string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'removeLiquidityADA', values: [string, BigNumberish, BigNumberish, BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'removeLiquidityADASupportingFeeOnTransferTokens', values: [string, BigNumberish, BigNumberish, BigNumberish, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'removeLiquidityADAWithPermit', values: [
        string,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: 'removeLiquidityADAWithPermitSupportingFeeOnTransferTokens', values: [
        string,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    encodeFunctionData(functionFragment: 'swapADAForExactTokens', values: [BigNumberish, string[], string, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'swapExactADAForTokens', values: [BigNumberish, string[], string, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'swapExactADAForTokensSupportingFeeOnTransferTokens', values: [BigNumberish, string[], string, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'swapExactTokensForADA', values: [BigNumberish, BigNumberish, string[], string, BigNumberish]): string;
    encodeFunctionData(functionFragment: 'swapExactTokensForADASupportingFeeOnTransferTokens', values: [BigNumberish, BigNumberish, string[], string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'swapTokensForExactADA', values: [BigNumberish, BigNumberish, string[], string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: 'removeLiquidityADAWithPermitSupportingFeeOnTransferTokens', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'swapExactADAForTokensSupportingFeeOnTransferTokens', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'swapExactTokensForADA', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'swapExactTokensForADASupportingFeeOnTransferTokens', data: BytesLike): Result;
...
export interface AdaRouter extends BaseContract {
    ...
    functions: {
        ...
        addLiquidityADA(token: string, amountTokenDesired: BigNumberish, amountTokenMin: BigNumberish, amountADAMin: BigNumberish, to: string, deadline: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        removeLiquidityADA(token: string, liquidity: BigNumberish, amountTokenMin: BigNumberish, amountADAMin: BigNumberish, to: string, deadline: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        removeLiquidityADASupportingFeeOnTransferTokens(token: string, liquidity: BigNumberish, amountTokenMin: BigNumberish, amountADAMin: BigNumberish, to: string, deadline: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        removeLiquidityADAWithPermit(token: string, liquidity: BigNumberish, amountTokenMin: BigNumberish, amountADAMin: BigNumberish, to: string, deadline: BigNumberish, approveMax: boolean, v: BigNumberish, r: BytesLike, s: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        removeLiquidityADAWithPermitSupportingFeeOnTransferTokens(token: string, liquidity: BigNumberish, amountTokenMin: BigNumberish, amountADAMin: BigNumberish, to: string, deadline: BigNumberish, approveMax: boolean, v: BigNumberish, r: BytesLike, s: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        swapADAForExactTokens(amountOut: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        swapExactADAForTokens(amountOutMin: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        swapExactADAForTokensSupportingFeeOnTransferTokens(amountOutMin: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        swapExactTokensForADA(amountIn: BigNumberish, amountOutMin: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        swapExactTokensForADASupportingFeeOnTransferTokens(amountIn: BigNumberish, amountOutMin: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        swapTokensForExactADA(amountOut: BigNumberish, amountInMax: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        addLiquidityADA(token: string, amountTokenDesired: BigNumberish, amountTokenMin: BigNumberish, amountADAMin: BigNumberish, to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber
        ] & {
        ...
        removeLiquidityADA(token: string, liquidity: BigNumberish, amountTokenMin: BigNumberish, amountADAMin: BigNumberish, to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            amountToken: BigNumber;
            amountADA: BigNumber;
        }>;
        removeLiquidityADASupportingFeeOnTransferTokens(token: string, liquidity: BigNumberish, amountTokenMin: BigNumberish, amountADAMin: BigNumberish, to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        removeLiquidityADAWithPermit(token: string, liquidity: BigNumberish, amountTokenMin: BigNumberish, amountADAMin: BigNumberish, to: string, deadline: BigNumberish, approveMax: boolean, v: BigNumberish, r: BytesLike, s: BytesLike, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            amountToken: BigNumber;
            amountADA: BigNumber;
        }>;
        removeLiquidityADAWithPermitSupportingFeeOnTransferTokens(token: string, liquidity: BigNumberish, amountTokenMin: BigNumberish, amountADAMin: BigNumberish, to: string, deadline: BigNumberish, approveMax: boolean, v: BigNumberish, r: BytesLike, s: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        swapADAForExactTokens(amountOut: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<BigNumber[]>;
        swapExactADAForTokens(amountOutMin: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<BigNumber[]>;
        swapExactADAForTokensSupportingFeeOnTransferTokens(amountOutMin: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<void>;
        swapExactTokensForADA(amountIn: BigNumberish, amountOutMin: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<BigNumber[]>;
        swapExactTokensForADASupportingFeeOnTransferTokens(amountIn: BigNumberish, amountOutMin: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        swapTokensForExactADA(amountOut: BigNumberish, amountInMax: BigNumberish, path: string[], to: string, deadline: BigNumberish, overrides?: CallOverrides): Promise<BigNumber[]>;
