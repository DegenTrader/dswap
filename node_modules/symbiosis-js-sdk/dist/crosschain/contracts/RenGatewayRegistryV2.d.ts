...
export interface RenGatewayRegistryV2Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: '__GatewayRegistry_init', values: [BigNumberish, string, string, string, string, string, string, string[]]): string;
    ...
    encodeFunctionData(functionFragment: 'deployMintGatewayAndRenAsset', values: [string, string, string, BigNumberish, string]): string;
...
export declare type LockGatewayProxyDeployedEvent = TypedEvent<[
    string,
    string,
    string,
    string
...
export declare type LockGatewayProxyDeployedEventFilter = TypedEventFilter<LockGatewayProxyDeployedEvent>;
export declare type LogLockGatewayAddedEvent = TypedEvent<[
    string,
    string,
    string,
    string
...
export declare type LogLockGatewayAddedEventFilter = TypedEventFilter<LogLockGatewayAddedEvent>;
export declare type LogLockGatewayRemovedEvent = TypedEvent<[string, string], {
    symbol: string;
    indexedSymbol: string;
}>;
export declare type LogLockGatewayRemovedEventFilter = TypedEventFilter<LogLockGatewayRemovedEvent>;
export declare type LogMintGatewayAddedEvent = TypedEvent<[
    string,
    string,
    string,
    string
...
export declare type LogMintGatewayAddedEventFilter = TypedEventFilter<LogMintGatewayAddedEvent>;
export declare type LogMintGatewayRemovedEvent = TypedEvent<[string, string], {
    symbol: string;
    indexedSymbol: string;
}>;
export declare type LogMintGatewayRemovedEventFilter = TypedEventFilter<LogMintGatewayRemovedEvent>;
...
export declare type LogTransferContractUpdatedEvent = TypedEvent<[
    string,
    string
], {
    oldTransferContract: string;
    newTransferContract: string;
}>;
export declare type LogTransferContractUpdatedEventFilter = TypedEventFilter<LogTransferContractUpdatedEvent>;
export declare type MintGatewayProxyDeployedEvent = TypedEvent<[
    string,
    string,
    string,
    string
...
export declare type MintGatewayProxyDeployedEventFilter = TypedEventFilter<MintGatewayProxyDeployedEvent>;
export declare type RenAssetProxyDeployedEvent = TypedEvent<[
    BigNumber,
    string,
    string,
    string,
...
export declare type RenAssetProxyDeployedEventFilter = TypedEventFilter<RenAssetProxyDeployedEvent>;
...
export declare type RoleGrantedEvent = TypedEvent<[string, string, string], {
    role: string;
    account: string;
    sender: string;
}>;
export declare type RoleGrantedEventFilter = TypedEventFilter<RoleGrantedEvent>;
export declare type RoleRevokedEvent = TypedEvent<[string, string, string], {
    role: string;
    account: string;
    sender: string;
}>;
...
export interface RenGatewayRegistryV2 extends BaseContract {
    ...
    functions: {
        ...
        __GatewayRegistry_init(chainId_: BigNumberish, signatureVerifier_: string, transferContract: string, renAssetProxyBeacon_: string, mintGatewayProxyBeacon_: string, lockGatewayProxyBeacon_: string, adminAddress: string, gatewayDeployers: string[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        __RenAssetFactory_init(renAssetProxyBeacon_: string, mintGatewayProxyBeacon_: string, lockGatewayProxyBeacon_: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        addLockGateway(symbol: string, lockAsset: string, lockGateway: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        addMintGateway(symbol: string, renAsset: string, mintGateway: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        deployLockGateway(symbol: string, lockToken: string, version: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        deployMintGateway(symbol: string, renAsset: string, version: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        deployMintGatewayAndRenAsset(symbol: string, erc20Name: string, erc20Symbol: string, erc20Decimals: BigNumberish, version: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        removeLockGateway(symbol: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        removeMintGateway(symbol: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        updateTransferContract(newTransferContract: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    CAN_ADD_GATEWAYS(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        DEFAULT_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
        NAME(overrides?: CallOverrides): Promise<string>;
        __GatewayRegistry_init(chainId_: BigNumberish, signatureVerifier_: string, transferContract: string, renAssetProxyBeacon_: string, mintGatewayProxyBeacon_: string, lockGatewayProxyBeacon_: string, adminAddress: string, gatewayDeployers: string[], overrides?: CallOverrides): Promise<void>;
        __RenAssetFactory_init(renAssetProxyBeacon_: string, mintGatewayProxyBeacon_: string, lockGatewayProxyBeacon_: string, overrides?: CallOverrides): Promise<void>;
        ...
        deployMintGatewayAndRenAsset(symbol: string, erc20Name: string, erc20Symbol: string, erc20Decimals: BigNumberish, version: string, overrides?: CallOverrides): Promise<void>;
        getChainId(overrides?: CallOverrides): Promise<BigNumber>;
        getGatewayBySymbol(tokenSymbol: string, overrides?: CallOverrides): Promise<string>;
        getGatewayByToken(token: string, overrides?: CallOverrides): Promise<string>;
        getLockAssetBySymbol(tokenSymbol: string, overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        'LockGatewayProxyDeployed(string,address,address,string)'(asset?: null, signatureVerifier?: null, token?: null, version?: null): LockGatewayProxyDeployedEventFilter;
        LockGatewayProxyDeployed(asset?: null, signatureVerifier?: null, token?: null, version?: null): LockGatewayProxyDeployedEventFilter;
        'LogLockGatewayAdded(string,address,address,string)'(symbol?: null, token?: string | null, gatewayContract?: string | null, indexedSymbol?: string | null): LogLockGatewayAddedEventFilter;
        LogLockGatewayAdded(symbol?: null, token?: string | null, gatewayContract?: string | null, indexedSymbol?: string | null): LogLockGatewayAddedEventFilter;
        'LogLockGatewayRemoved(string,string)'(symbol?: null, indexedSymbol?: string | null): LogLockGatewayRemovedEventFilter;
        LogLockGatewayRemoved(symbol?: null, indexedSymbol?: string | null): LogLockGatewayRemovedEventFilter;
        'LogMintGatewayAdded(string,address,address,string)'(symbol?: null, token?: string | null, gatewayContract?: string | null, indexedSymbol?: string | null): LogMintGatewayAddedEventFilter;
        LogMintGatewayAdded(symbol?: null, token?: string | null, gatewayContract?: string | null, indexedSymbol?: string | null): LogMintGatewayAddedEventFilter;
        'LogMintGatewayRemoved(string,string)'(symbol?: null, indexedSymbol?: string | null): LogMintGatewayRemovedEventFilter;
        ...
        'LogTransferContractUpdated(address,address)'(oldTransferContract?: string | null, newTransferContract?: string | null): LogTransferContractUpdatedEventFilter;
        LogTransferContractUpdated(oldTransferContract?: string | null, newTransferContract?: string | null): LogTransferContractUpdatedEventFilter;
        'MintGatewayProxyDeployed(string,address,address,string)'(asset?: null, signatureVerifier?: null, token?: null, version?: null): MintGatewayProxyDeployedEventFilter;
        MintGatewayProxyDeployed(asset?: null, signatureVerifier?: null, token?: null, version?: null): MintGatewayProxyDeployedEventFilter;
        'RenAssetProxyDeployed(uint256,string,string,string,uint8,string)'(chainId?: null, asset?: null, name?: null, symbol?: null, decimals?: null, version?: null): RenAssetProxyDeployedEventFilter;
        RenAssetProxyDeployed(chainId?: null, asset?: null, name?: null, symbol?: null, decimals?: null, version?: null): RenAssetProxyDeployedEventFilter;
    ...
    populateTransaction: {
        ...
        getLockGatewaySymbols(from: BigNumberish, count: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getMintGatewaySymbols(from: BigNumberish, count: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
