...
export declare type RepresentationCreatedEvent = TypedEvent<[
    string,
    BigNumber,
    string
], {
...
export declare type RepresentationCreatedEventFilter = TypedEventFilter<RepresentationCreatedEvent>;
