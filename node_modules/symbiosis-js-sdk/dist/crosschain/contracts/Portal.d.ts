...
export interface PortalInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'metaSynthesize', values: [MetaRouteStructs.MetaSynthesizeTransactionStruct]): string;
    encodeFunctionData(functionFragment: 'metaUnsynthesize', values: [BigNumberish, BytesLike, string, BigNumberish, string, string, BytesLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'revertBurnRequest', values: [BigNumberish, BytesLike, string, string, BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: 'synthesize', values: [BigNumberish, string, BigNumberish, string, string, string, string, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: 'synthesizeNative', values: [BigNumberish, string, string, string, string, BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: 'unsynthesize', values: [BigNumberish, BytesLike, string, BigNumberish, string]): string;
...
export declare type BurnCompletedEvent = TypedEvent<[
    string,
    string,
    BigNumber,
    BigNumber,
...
export declare type BurnCompletedEventFilter = TypedEventFilter<BurnCompletedEvent>;
export declare type ClientIdLogEvent = TypedEvent<[string, string], {
    requestId: string;
    clientId: string;
}>;
export declare type ClientIdLogEventFilter = TypedEventFilter<ClientIdLogEvent>;
...
export declare type RevertBurnRequestEvent = TypedEvent<[string, string], {
    id: string;
    to: string;
}>;
export declare type RevertBurnRequestEventFilter = TypedEventFilter<RevertBurnRequestEvent>;
export declare type RevertSynthesizeCompletedEvent = TypedEvent<[
    string,
    string,
    BigNumber,
    BigNumber,
...
export declare type RevertSynthesizeCompletedEventFilter = TypedEventFilter<RevertSynthesizeCompletedEvent>;
export declare type SetMetaRouterEvent = TypedEvent<[string], {
    metaRouter: string;
}>;
export declare type SetMetaRouterEventFilter = TypedEventFilter<SetMetaRouterEvent>;
export declare type SetTokenThresholdEvent = TypedEvent<[string, BigNumber], {
    token: string;
    threshold: BigNumber;
}>;
export declare type SetTokenThresholdEventFilter = TypedEventFilter<SetTokenThresholdEvent>;
export declare type SetWhitelistTokenEvent = TypedEvent<[string, boolean], {
    token: string;
    activate: boolean;
}>;
export declare type SetWhitelistTokenEventFilter = TypedEventFilter<SetWhitelistTokenEvent>;
export declare type SynthesizeRequestEvent = TypedEvent<[
    string,
    string,
    BigNumber,
    string,
...
export declare type SynthesizeRequestEventFilter = TypedEventFilter<SynthesizeRequestEvent>;
...
export interface Portal extends BaseContract {
    ...
    functions: {
        ...
        metaSynthesize(_metaSynthesizeTransaction: MetaRouteStructs.MetaSynthesizeTransactionStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        metaUnsynthesize(_stableBridgingFee: BigNumberish, _externalID: BytesLike, _to: string, _amount: BigNumberish, _rToken: string, _finalReceiveSide: string, _finalCalldata: BytesLike, _finalOffset: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        revertBurnRequest(_stableBridgingFee: BigNumberish, _internalID: BytesLike, _receiveSide: string, _oppositeBridge: string, _chainId: BigNumberish, _clientID: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        revertSynthesize(_stableBridgingFee: BigNumberish, _externalID: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        synthesize(_stableBridgingFee: BigNumberish, _token: string, _amount: BigNumberish, _chain2address: string, _receiveSide: string, _oppositeBridge: string, _revertableAddress: string, _chainID: BigNumberish, _clientID: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        synthesizeNative(_stableBridgingFee: BigNumberish, _chain2address: string, _receiveSide: string, _oppositeBridge: string, _revertableAddress: string, _chainID: BigNumberish, _clientID: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        unsynthesize(_stableBridgingFee: BigNumberish, _externalID: BytesLike, _token: string, _amount: BigNumberish, _to: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        isTrustedForwarder(forwarder: string, overrides?: CallOverrides): Promise<boolean>;
        metaRouter(overrides?: CallOverrides): Promise<string>;
        metaSynthesize(_metaSynthesizeTransaction: MetaRouteStructs.MetaSynthesizeTransactionStruct, overrides?: CallOverrides): Promise<string>;
        metaUnsynthesize(_stableBridgingFee: BigNumberish, _externalID: BytesLike, _to: string, _amount: BigNumberish, _rToken: string, _finalReceiveSide: string, _finalCalldata: BytesLike, _finalOffset: BigNumberish, overrides?: CallOverrides): Promise<void>;
        owner(overrides?: CallOverrides): Promise<string>;
        ...
        revertBurnRequest(_stableBridgingFee: BigNumberish, _internalID: BytesLike, _receiveSide: string, _oppositeBridge: string, _chainId: BigNumberish, _clientID: BytesLike, overrides?: CallOverrides): Promise<void>;
        revertSynthesize(_stableBridgingFee: BigNumberish, _externalID: BytesLike, overrides?: CallOverrides): Promise<void>;
        ...
        synthesize(_stableBridgingFee: BigNumberish, _token: string, _amount: BigNumberish, _chain2address: string, _receiveSide: string, _oppositeBridge: string, _revertableAddress: string, _chainID: BigNumberish, _clientID: BytesLike, overrides?: CallOverrides): Promise<string>;
        synthesizeNative(_stableBridgingFee: BigNumberish, _chain2address: string, _receiveSide: string, _oppositeBridge: string, _revertableAddress: string, _chainID: BigNumberish, _clientID: BytesLike, overrides?: CallOverrides): Promise<string>;
        ...
        unsynthesize(_stableBridgingFee: BigNumberish, _externalID: BytesLike, _token: string, _amount: BigNumberish, _to: string, overrides?: CallOverrides): Promise<void>;
        unsynthesizeStates(arg0: BytesLike, overrides?: CallOverrides): Promise<number>;
        versionRecipient(overrides?: CallOverrides): Promise<string>;
        wrapper(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
        'BurnCompleted(bytes32,address,uint256,uint256,address)'(id?: BytesLike | null, to?: string | null, amount?: null, bridgingFee?: null, token?: null): BurnCompletedEventFilter;
        BurnCompleted(id?: BytesLike | null, to?: string | null, amount?: null, bridgingFee?: null, token?: null): BurnCompletedEventFilter;
        ...
        'RevertSynthesizeCompleted(bytes32,address,uint256,uint256,address)'(id?: BytesLike | null, to?: string | null, amount?: null, bridgingFee?: null, token?: null): RevertSynthesizeCompletedEventFilter;
        RevertSynthesizeCompleted(id?: BytesLike | null, to?: string | null, amount?: null, bridgingFee?: null, token?: null): RevertSynthesizeCompletedEventFilter;
