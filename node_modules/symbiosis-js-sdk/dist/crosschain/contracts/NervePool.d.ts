...
export interface NervePoolInterface extends utils.Interface {
    contractName: 'NervePool';
    functions: {
    ...
    encodeFunctionData(functionFragment: 'setDefaultDepositFee', values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: 'setDefaultWithdrawFee', values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'swap', values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: 'setDefaultDepositFee', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'setDefaultWithdrawFee', data: BytesLike): Result;
...
export declare type NewAdminFeeEvent = TypedEvent<[BigNumber], {
    newAdminFee: BigNumber;
}>;
export declare type NewAdminFeeEventFilter = TypedEventFilter<NewAdminFeeEvent>;
export declare type NewDepositFeeEvent = TypedEvent<[BigNumber], {
    newDepositFee: BigNumber;
}>;
export declare type NewDepositFeeEventFilter = TypedEventFilter<NewDepositFeeEvent>;
export declare type NewSwapFeeEvent = TypedEvent<[BigNumber], {
    newSwapFee: BigNumber;
}>;
export declare type NewSwapFeeEventFilter = TypedEventFilter<NewSwapFeeEvent>;
export declare type NewWithdrawFeeEvent = TypedEvent<[BigNumber], {
...
export declare type StopRampAEvent = TypedEvent<[BigNumber, BigNumber], {
    currentA: BigNumber;
    time: BigNumber;
}>;
...
export interface NervePool extends BaseContract {
    contractName: 'NervePool';
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: NervePoolInterface;
    ...
    functions: {
        ...
        setDefaultDepositFee(newDepositFee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setDefaultWithdrawFee(newWithdrawFee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setDevAddress(_devaddr: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setDefaultDepositFee(newDepositFee: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setDefaultWithdrawFee(newWithdrawFee: BigNumberish, overrides?: CallOverrides): Promise<void>;
