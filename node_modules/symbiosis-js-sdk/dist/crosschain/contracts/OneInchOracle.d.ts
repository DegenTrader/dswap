...
export declare type ConnectorAddedEvent = TypedEvent<[string], {
    connector: string;
}>;
export declare type ConnectorAddedEventFilter = TypedEventFilter<ConnectorAddedEvent>;
export declare type ConnectorRemovedEvent = TypedEvent<[string], {
    connector: string;
}>;
export declare type ConnectorRemovedEventFilter = TypedEventFilter<ConnectorRemovedEvent>;
export declare type MultiWrapperUpdatedEvent = TypedEvent<[string], {
    multiWrapper: string;
}>;
export declare type MultiWrapperUpdatedEventFilter = TypedEventFilter<MultiWrapperUpdatedEvent>;
export declare type OracleAddedEvent = TypedEvent<[string, number], {
    oracle: string;
    oracleType: number;
}>;
export declare type OracleAddedEventFilter = TypedEventFilter<OracleAddedEvent>;
export declare type OracleRemovedEvent = TypedEvent<[string, number], {
    oracle: string;
    oracleType: number;
}>;
export declare type OracleRemovedEventFilter = TypedEventFilter<OracleRemovedEvent>;
