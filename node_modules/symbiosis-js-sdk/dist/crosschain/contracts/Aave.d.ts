...
export declare namespace DataTypes {
    ...
    type EModeCategoryStructOutput = [number, number, number, string, string] & {
        ltv: number;
...
export interface AaveInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'flashLoan', values: [string, string[], BigNumberish[], BigNumberish[], string, BytesLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: 'repayWithPermit', values: [string, BigNumberish, BigNumberish, string, BigNumberish, BigNumberish, BytesLike, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: 'supplyWithPermit', values: [string, BigNumberish, string, BigNumberish, BigNumberish, BigNumberish, BytesLike, BytesLike]): string;
...
export declare type MintedToTreasuryEvent = TypedEvent<[string, BigNumber], {
    reserve: string;
    amountMinted: BigNumber;
}>;
export declare type MintedToTreasuryEventFilter = TypedEventFilter<MintedToTreasuryEvent>;
export declare type RebalanceStableBorrowRateEvent = TypedEvent<[string, string], {
    reserve: string;
    user: string;
}>;
...
export declare type ReserveUsedAsCollateralDisabledEvent = TypedEvent<[string, string], {
    reserve: string;
    user: string;
}>;
export declare type ReserveUsedAsCollateralDisabledEventFilter = TypedEventFilter<ReserveUsedAsCollateralDisabledEvent>;
export declare type ReserveUsedAsCollateralEnabledEvent = TypedEvent<[string, string], {
    reserve: string;
    user: string;
}>;
...
export declare type UserEModeSetEvent = TypedEvent<[string, number], {
    user: string;
    categoryId: number;
}>;
...
export interface Aave extends BaseContract {
    ...
    functions: {
        ...
        configureEModeCategory(id: BigNumberish, category: DataTypes.EModeCategoryStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        initialize(provider: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        updateBridgeProtocolFee(protocolFee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        MAX_STABLE_RATE_BORROW_SIZE_PERCENT(overrides?: CallOverrides): Promise<BigNumber>;
        POOL_REVISION(overrides?: CallOverrides): Promise<BigNumber>;
        backUnbacked(asset: string, amount: BigNumberish, fee: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        configureEModeCategory(id: BigNumberish, category: DataTypes.EModeCategoryStruct, overrides?: CallOverrides): Promise<void>;
        ...
        updateBridgeProtocolFee(protocolFee: BigNumberish, overrides?: CallOverrides): Promise<void>;
