...
export declare type NewStratCandidateEvent = TypedEvent<[string], {
    implementation: string;
}>;
export declare type NewStratCandidateEventFilter = TypedEventFilter<NewStratCandidateEvent>;
...
export declare type UpgradeStratEvent = TypedEvent<[string], {
    implementation: string;
}>;
export declare type UpgradeStratEventFilter = TypedEventFilter<UpgradeStratEvent>;
export interface BeefyVault extends BaseContract {
    ...
    functions: {
        ...
        stratCandidate(overrides?: CallOverrides): Promise<[string, BigNumber] & {
            implementation: string;
