...
export declare type ActionPaused_string_bool_Event = TypedEvent<[string, boolean], {
    action: string;
    pauseState: boolean;
}>;
...
export declare type MarketDelistedEvent = TypedEvent<[string], {
    cToken: string;
}>;
export declare type MarketDelistedEventFilter = TypedEventFilter<MarketDelistedEvent>;
export declare type MarketEnteredEvent = TypedEvent<[string, string], {
    cToken: string;
    account: string;
}>;
export declare type MarketEnteredEventFilter = TypedEventFilter<MarketEnteredEvent>;
export declare type MarketExitedEvent = TypedEvent<[string, string], {
    cToken: string;
    account: string;
}>;
...
export declare type NewBorrowCapEvent = TypedEvent<[string, BigNumber], {
    cToken: string;
...
export declare type NewCTokenVersionEvent = TypedEvent<[
    string,
    number,
    number
], {
...
export declare type NewCTokenVersionEventFilter = TypedEventFilter<NewCTokenVersionEvent>;
...
export declare type NewLiquidityMiningEvent = TypedEvent<[
    string,
    string
], {
    oldLiquidityMining: string;
    newLiquidityMining: string;
}>;
export declare type NewLiquidityMiningEventFilter = TypedEventFilter<NewLiquidityMiningEvent>;
export declare type NewPauseGuardianEvent = TypedEvent<[string, string], {
...
export declare type NewPriceOracleEvent = TypedEvent<[string, string], {
    oldPriceOracle: string;
    newPriceOracle: string;
}>;
export declare type NewPriceOracleEventFilter = TypedEventFilter<NewPriceOracleEvent>;
export declare type NewSupplyCapEvent = TypedEvent<[string, BigNumber], {
    cToken: string;
    newSupplyCap: BigNumber;
}>;
export declare type NewSupplyCapEventFilter = TypedEventFilter<NewSupplyCapEvent>;
export declare type NewSupplyCapGuardianEvent = TypedEvent<[
    string,
    string
], {
...
export declare type NewSupplyCapGuardianEventFilter = TypedEventFilter<NewSupplyCapGuardianEvent>;
export interface CreamComptroller extends BaseContract {
    ...
    functions: {
        ...
        _delistMarket(cToken: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        _setFlashloanPaused(cToken: string, state: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        _setLiquidationIncentive(newLiquidationIncentiveMantissa: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        _setLiquidityMining(newLiquidityMining: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        _setSupplyCapGuardian(newSupplyCapGuardian: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        _setTransferPaused(state: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        _supportMarket(cToken: string, version: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        flashloanAllowed(cToken: string, receiver: string, amount: BigNumberish, params: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        updateCTokenVersion(cToken: string, newVersion: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    _become(unitroller: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        flashloanAllowed(cToken: string, receiver: string, amount: BigNumberish, params: BytesLike, overrides?: CallOverrides): Promise<void>;
        flashloanGuardianPaused(arg0: string, overrides?: CallOverrides): Promise<boolean>;
        getAccountLiquidity(account: string, overrides?: CallOverrides): Promise<[BigNumber, BigNumber, BigNumber]>;
        getAllMarkets(overrides?: CallOverrides): Promise<string[]>;
        getAssetsIn(account: string, overrides?: CallOverrides): Promise<string[]>;
    ...
    filters: {
        ...
        'NewCTokenVersion(address,uint8,uint8)'(cToken?: null, oldVersion?: null, newVersion?: null): NewCTokenVersionEventFilter;
        ...
        'NewLiquidityMining(address,address)'(oldLiquidityMining?: null, newLiquidityMining?: null): NewLiquidityMiningEventFilter;
        ...
        'NewSupplyCapGuardian(address,address)'(oldSupplyCapGuardian?: null, newSupplyCapGuardian?: null): NewSupplyCapGuardianEventFilter;
