...
export declare type NewProtocolSeizeShareEvent = TypedEvent<[
    BigNumber,
    BigNumber
], {
...
export declare type NewProtocolSeizeShareEventFilter = TypedEventFilter<NewProtocolSeizeShareEvent>;
...
export interface BenqiQiErc20 extends BaseContract {
    ...
    functions: {
        ...
        _setProtocolSeizeShare(newProtocolSeizeShareMantissa: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        delegateToImplementation(data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        liquidateBorrow(borrower: string, repayAmount: BigNumberish, qiTokenCollateral: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        _setProtocolSeizeShare(newProtocolSeizeShareMantissa: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        interestRateModel(overrides?: CallOverrides): Promise<string>;
        isQiToken(overrides?: CallOverrides): Promise<boolean>;
        liquidateBorrow(borrower: string, repayAmount: BigNumberish, qiTokenCollateral: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        ...
        'LiquidateBorrow(address,address,uint256,address,uint256)'(liquidator?: null, borrower?: null, repayAmount?: null, qiTokenCollateral?: null, seizeTokens?: null): LiquidateBorrowEventFilter;
        LiquidateBorrow(liquidator?: null, borrower?: null, repayAmount?: null, qiTokenCollateral?: null, seizeTokens?: null): LiquidateBorrowEventFilter;
        ...
        'NewProtocolSeizeShare(uint256,uint256)'(oldProtocolSeizeShareMantissa?: null, newProtocolSeizeShareMantissa?: null): NewProtocolSeizeShareEventFilter;
        NewProtocolSeizeShare(oldProtocolSeizeShareMantissa?: null, newProtocolSeizeShareMantissa?: null): NewProtocolSeizeShareEventFilter;
