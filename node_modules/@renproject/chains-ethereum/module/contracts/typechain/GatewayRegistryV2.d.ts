...
export interface GatewayRegistryV2Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "__GatewayRegistry_init", values: [
        BigNumberish,
        string,
        string,
        string,
...
export declare type LogLockGatewayRemovedEvent = TypedEvent<[
    string,
    string
], {
    symbol: string;
...
export declare type LogMintGatewayRemovedEvent = TypedEvent<[
    string,
    string
], {
    symbol: string;
...
//# sourceMappingURL=GatewayRegistryV2.d.ts.map