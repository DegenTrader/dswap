...
exports.concat = exports.newPromiEvent = exports.isHex = exports.isURLBase64 = exports.isBase64 = exports.toURLBase64 = exports.toBase64 = exports.fromBase64 = exports.fromUTF8String = exports.toUTF8String = exports.fromHex = exports.Ox = exports.toHex = exports.strip0x = exports.memoize = exports.fromBytes = exports.toNBytes = exports.padUint8Array = exports.doesntError = exports.isDefined = exports.tryIndefinitely = exports.tryNTimes = void 0;
const base64 = __importStar(require("base64-js"));
const bignumber_js_1 = __importDefault(require("bignumber.js"));
const immutable_1 = require("immutable");
const errors_1 = require("../errors");
const promiEvent_1 = require("../libraries/promiEvent");
const assert_1 = require("./assert");
const extractError_1 = require("./extractError");
 ...
 */
const tryNTimes = async (fnCall, retries, timeout = 1 * sleep_1.sleep.SECONDS, // in ms
logger) => {
    if (retries === 0 || typeof retries !== "number" || isNaN(retries)) {
        throw errors_1.ErrorWithCode.updateError(new Error(`Invalid retry amount '${retries}'.`), errors_1.RenJSError.PARAMETER_ERROR);
    }
    let returnError;
    ...
    for (let i = 0; retries === -1 || i < retries; i++) {
        try {
            ...
            // Fix error message.
            const errorMessage = (0, extractError_1.extractError)(error);
            errorMessages.add(errorMessage);
            returnError =
                errors_1.ErrorWithCode.updateError(error, error.code || errors_1.RenJSError.INTERNAL_ERROR) || returnError;
...
const tryIndefinitely = async (fnCall) => (0, exports.tryNTimes)(fnCall, -1, 15 * sleep_1.sleep.SECONDS, console);
exports.tryIndefinitely = tryIndefinitely;
/**
 ...
 */
const memoize = (fn, { expiry = (5 * sleep_1.sleep.MINUTES), entryLimit = 100 } = {
    expiry: (5 * sleep_1.sleep.MINUTES),
    entryLimit: 100,
}) => {
 ...
 */
const newPromiEvent = (eventEmitter) => new promiEvent_1.Web3PromiEvent(eventEmitter);
