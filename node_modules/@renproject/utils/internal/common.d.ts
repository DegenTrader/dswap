 ...
 */
export declare const tryNTimes: <T>(fnCall: (attempt: number, retries: number) => Promise<T>, retries: number, timeout?: number, logger?: Logger) => Promise<T>;
export declare const tryIndefinitely: <T>(fnCall: (attempt: number, retries: number) => Promise<T>) => Promise<T>;
/**
...
export declare const newPromiEvent: <T, EventTypes extends {
    [event: string]: any[];
} = {}>(eventEmitter?: EventEmitterTyped<EventTypes> | undefined) => PromiEvent<T, EventTypes>;
/**
