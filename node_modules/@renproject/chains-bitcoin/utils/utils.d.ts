import { BitcoinNetworkConfig, BitcoinNetworkConfigMap, BitcoinNetworkInput } from "./types";
...
export declare const resolveBitcoinNetworkConfig: (configMap: BitcoinNetworkConfigMap, renNetwork: BitcoinNetworkInput) => BitcoinNetworkConfig;
